...
with open('../Sample_files/AttorneyObjects.json', 'w', encoding="utf8") as outfile:
    outfile.write(json_string)
temp = open('../Sample_files/AttorneyObjects.json')
data = json.load(temp)
with open("../Sample_files/AttorneyObjects.json", 'w') as outfile:
